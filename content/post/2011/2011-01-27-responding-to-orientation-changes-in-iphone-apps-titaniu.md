+++
title = "Responding to Orientation Changes in Iphone Apps Titaniu"
date = "2011-01-27"
slug = "'2011/1/27'/responding-to-orientation-changes-in-iphone-apps-titaniu"
Categories = []
+++
...
Ti.Gesture.addEventListener("orientationchange", function (e) {
  ...
  if (
    e.orientation == Titanium.UI.LANDSCAPE_LEFT ||
